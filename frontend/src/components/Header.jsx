      ...
      <div className="container-custom">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.a
              href="tel:911"
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 bg-red-500 text-white text-xs font-bold rounded-full animate-pulse-green hover:bg-red-600 transition-colors"
              style={{ "--tw-ring-color": "rgba(239, 68, 68, 0.7)" }}
